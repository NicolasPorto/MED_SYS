...
public class ADM_IncluirFornecedor extends javax.swing.JDialog {

  
    public ADM_IncluirFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Incluir Fornecedor");
    ...
    public void cadastrar(){
        ...
        if (banco.getConnection()){ 
            try{
                String query = "insert into fornecedores (nome_fornecedor, telefone_fornecedor, email_fornecedor, estado_fornecedor, cidade_fornecedor, cnpj_fornecedor) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ADM_IncluirFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ADM_IncluirFornecedor dialog = new ADM_IncluirFornecedor(new javax.swing.JFrame(), true);
