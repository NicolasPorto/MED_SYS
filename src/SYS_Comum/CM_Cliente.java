...
public class CM_Cliente extends javax.swing.JDialog {

    public CM_Cliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tabela_Cliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "CPF", "Nome", "Email", "Estado", "Cidade", "Telefone"
            }
        ) {
    ...
    public void pesquisar(){
        ...
        if (banco.getConnection()){
            ...
            if(ComboBox1.getSelectedItem().equals("CPF")){

                try {

                    String query = "select * from clientes where cpf_cliente like ?";
                ...
                try {
                    ...
                    String query = "select * from clientes where estado_cliente like ?";
                    PreparedStatement stmp = banco.connection.prepareStatement(query);
                    stmp.setString(1, "%" + txtPesquisa.getText()+"%");
                    ResultSet rs = stmp.executeQuery();
                    DefaultTableModel model = (DefaultTableModel) tabela_Cliente.getModel();
                ...
                try {
                    ...
                    String query = "select * from clientes where cidade_cliente like ?";
                    PreparedStatement stmp = banco.connection.prepareStatement(query);
                    stmp.setString(1, "%" + txtPesquisa.getText()+"%");
                    ResultSet rs = stmp.executeQuery();
                    DefaultTableModel model = (DefaultTableModel) tabela_Cliente.getModel();
                ...
                try {
                    ...
                    String query = "select * from clientes where telefone_cliente like ?";
                    PreparedStatement stmp = banco.connection.prepareStatement(query);
                    stmp.setString(1, "%" + txtPesquisa.getText()+"%");
                    ResultSet rs = stmp.executeQuery();
                    DefaultTableModel model = (DefaultTableModel) tabela_Cliente.getModel();
    ...
    private void bIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bIncluirActionPerformed
        ...
        CM_IncluirCliente incluir = new CM_IncluirCliente (null, true);
        dispose();
    ...
    private void bEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditarActionPerformed
      ...
      new CM_EditarCliente(FEID).show();
      this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CM_Cliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CM_Cliente dialog = new CM_Cliente(new javax.swing.JFrame(), true);
