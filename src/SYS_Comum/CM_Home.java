...
public class CM_Home extends javax.swing.JFrame {

    public static CM_Home Instance;
    ...
    private void initComponents() {
        ...
        kBCadastrarProduto.setText("Gerenciar Estoque");
    ...
    private void kBFornecedor_ADMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kBFornecedor_ADMActionPerformed
        CM_Fornecedor fornecedor = new CM_Fornecedor(null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CM_Home.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
